# Bounce keyword dictionary
bounce_keywords = {
    "BOUNCE CHARGES": {
    "type_keywords": ["bounce charges",  "cheque", "chq", "imps", "rtgs","nach", "ach", "ecs"],
    "keywords": [
        "achdebitreturncharges","ACH RTN CHRG","rtn chgs", "return chgs", "ret chgs", "rtn chrgs", "return chrgs", "ret chrgs",
        "rtn charges", "return charges", "retcharges","ret charges", "bounce charges", "debit return", "credit return", "rtnchg", "bounced charges", "rtn chrg", "rtn_chrg"
    ]
},
    "BOUNCE CHARGES - GST": {
